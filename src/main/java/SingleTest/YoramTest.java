...
public class YoramTest implements Runnable {
...
//        System.out.println((System.currentTimeMillis() - s) / 1000 + " Sec");
    ...
    public void LoginToCloud() {
        ...
        executionTimer.end();
        System.out.println("findElement(By.xpath( + .sendKeys -> " + executionTimer.duration());
        ...
        while (i < 25) {
            executionTimer.start();
            driver.findElement(By.xpath("//*[@id=\"side-menu\"]/li[3]")).click();
            executionTimer.end();
            System.out.println("findElement(By.xpath(+ click -> " + executionTimer.duration());
